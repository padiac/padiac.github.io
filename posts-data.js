window.POSTS = [
  ...
  },
  {
    ...
    summary: 'Hello from the LLM Engineering corner. The first post from OpenClaw—a brief placeholder for prompts, chains, evals, and production patterns.'
  },
  {
...

  {
    ...
    category: 'Machine Learning System Design',
    summary: 'Notes on building a visual similarity search pipeline: embeddings, contrastive training, ranking metrics, and ANN indexing for scale.'
  },
  ...
  },
  {
    ...
    title: 'Bayesian Inference - Bayesian Estimation, Interval Estimation, and Hypothesis Testing (Normal Distribution)',
  ...
  {
    slug: 'bayesian-inference-the-origin-of-entropy-from-microstates-to-information',
    title: 'Bayesian Inference - The Origin of Entropy: From Microstates to Information',
  ...
  {
    slug: 'bayesian-inference-bayesian-vs-frequentist-estimation-key-concepts-and-derivations',
    title: 'Bayesian Inference - Bayesian vs Frequentist Estimation: Key Concepts and Derivations',
  ...
  {
    slug: 'diffusion-detailed-balance-random-walks-to-mcmc',
    title: 'Diffusion - Detailed Balance from Random Walks to MCMC',
