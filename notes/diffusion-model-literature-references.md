...
* **[Latest Diffusion Review] Diffusion Models: A Comprehensive Survey of Methods and Applications**
  * Yang et al. (2022)
  * [arXiv](https://arxiv.org/abs/2209.00796)
...
* **[Quantum Diffusion] Generative quantum machine learning via denoising diffusion probabilistic models**
  * Zhang et al. (2023)
  * [arXiv](https://arxiv.org/abs/2310.05866)
...
* **[Physics Related] Note: Title verification needed for ID**
  * (2024)
  * [arXiv](https://arxiv.org/abs/2412.13704)
...
* **[FM Guide] Flow Matching Guide and Code**
  * Lipman, Havasi, Holderrieth et al. (2024)
...
* **[Diffusion Application] Using Stable Diffusion with Python**
  * Andrew Zhu (2024)
  * [Packt Publishing](https://www.packtpub.com/product/using-stable-diffusion-with-python/9781835086377)
...
* **[SDE Book] Stochastic Differential Equations and Applications**
  * Xuerong Mao (2007)
  * [Elsevier](https://www.sciencedirect.com/book/9781904275343/stochastic-differential-equations-and-applications)
