Measure theory generalizes length, area, and volume so that even highly fragmented sets can be assigned a meaningful size. A measure $\mu$ on a measurable space $(\Omega, \mathcal{F})$ satisfies three properties:
